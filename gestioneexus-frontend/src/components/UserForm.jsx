...
const UserForm = ({ onUserAdded, onUserUpdated, closeModal, userToEdit, loggedInUser }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Usamos la misma Expresión Regular actualizada del backend
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                     <FormField label={`Contraseña ${isEditing ? '(Opcional: solo si se desea cambiar)' : ''}`} name="password" type="password" value={formData.password} onChange={handleChange} required={!isEditing} />
